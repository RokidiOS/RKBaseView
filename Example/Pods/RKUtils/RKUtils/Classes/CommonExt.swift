...
public class UI: NSObject {
    ...
    static let ScreenScale = ScreenWidth / 375.0
    static let ScreenPixelScale = {return UIScreen.main.scale}()
    static let ScreenHeightScale =  ScreenHeight / 667.0
    static let SafeAreaInsets: UIEdgeInsets = {return ( Dev.IsIPhoneXScreen ? UIEdgeInsets.init(top: 24, left: 0, bottom: 24, right: 0) : UIEdgeInsets.zero)}()
...
//    var bundle = Bundle(for: RokidSDK.RKLoginViewController.classForCoder())
...
//    SDKBundle.localizedString(forKey: string, value: nil, table: nil)
    return ""
}
...
public extension UIImage {
    ...
    convenience init?(_ named: String,_ aclass: AnyClass) {
        let path = bundle(named, aclass)
